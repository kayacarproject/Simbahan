...
declare module 'expo-router' {
  export namespace ExpoRouter {
    export interface __routes<T extends string = string> extends Record<string, unknown> {
      StaticRoutes: `/` | `/(auth)` | `/(auth)/forgot-password` | `/(auth)/join-church` | `/(auth)/login` | `/(auth)/otp-verify` | `/(auth)/register` | `/(auth)/reset-password` | `/(public)` | `/(public)/` | `/(tabs)` | `/(tabs)/` | `/(tabs)/announcements` | `/(tabs)/calendar` | `/(tabs)/more` | `/(tabs)/parish` | `/(tabs)/schedule` | `/..\services\Api` | `/_sitemap` | `/announcements` | `/calendar` | `/community` | `/country-select` | `/donations` | `/donations/history` | `/events` | `/family` | `/forgot-password` | `/holy-week` | `/home` | `/join-church` | `/language-select` | `/login` | `/mass-schedule` | `/more` | `/notifications` | `/novenas` | `/novenas/rosary` | `/otp-verify` | `/parish` | `/parish-info` | `/profile` | `/profile/edit` | `/readings/today` | `/register` | `/reset-password` | `/sacraments` | `/sacraments/request` | `/schedule` | `/settings` | `/simbang-gabi` | `/welcome`;
